...
import pygame
from model.visuel import image, couleur, rectangle, texte
from model.jeu import plateau, de
...
class Interface:
    ...
    def Menu_bas(self, joueur):
        ...
        joueur.affichage_cle(self.get_fenetre())
        ...
        if joueur.get_prenom() == "Pierre":
            ...
            joueur.affichage_image(24,598,self.get_fenetre(),self.get_police())
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.QUIT:
                    ...
                    if touche_fleche == pygame.K_UP:
                        ...
                        # self.get_plateau_de_jeu().plateau_cache(self.get_fenetre())
                        self.get_plateau_de_jeu().mise_a_jour_plateau(self.get_fenetre())
                        joueur.affiche_tt_joueur(self.get_liste_joueur(),self.get_fenetre())
                        joueur.affichage_image_plateau(joueur.get_x(),joueur.get_y(),self.get_fenetre())
                        if avancer == True :
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.MOUSEBUTTONDOWN:  
                    if 500 < mouse_x < 725 and 150 < mouse_y < 450:
                        ...
                        joueur.affichage_potion(self.get_fenetre())
                        pygame.display.update()
                        pygame.time.delay(2500)
