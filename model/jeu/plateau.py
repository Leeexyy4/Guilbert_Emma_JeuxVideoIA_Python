...
from model.visuel import texte, couleur, rectangle, image
from model.personnage import ennemis
...
class Plateau:
                ...
                if event.type == pygame.MOUSEBUTTONDOWN:  
                    if 220 < mouse_x < 284 and 480 < mouse_y < 544:
                        ...
                        if joueur.get_pv() > 200:
                            ...
                            return interface.get_liste_joueur()
                        else :
                            rectangle.Rectangle(100, 590, 390, 80).affiche(interface.get_fenetre(), couleur.Couleur().get_Beige())
                    ...
                    if 360 < mouse_x < 424 and 475 < mouse_y < 539:
                        ...
                        if "reculer" in malus:
                            if malus == "reculer d'une case":
                                if joueur.get_plateaux() > 0:
                                    # Definir les nouveaux pv suite à l'echange
                                    joueur.set_plateaux((joueur.get_plateaux() - 1))
                                    interface.get_liste_joueur()[joueur.get_id()][3] = joueur.get_plateaux()
                                    
                                    pygame.display.update() # Mettre à jour l'affichage
                                    selection_malus = True
                                    return interface.get_liste_joueur()
                                elif joueur.get_plateauy() > 0 and joueur.get_plateaux() <= 0:
                                    # Definir les nouveaux pv suite à l'echange
                                    joueur.set_plateauy((joueur.get_plateauy() - 1))
                                    interface.get_liste_joueur()[joueur.get_id()][4] = joueur.get_plateauy()
                                    
                                    pygame.display.update() # Mettre à jour l'affichage
                                    selection_malus = True
                                    return interface.get_liste_joueur()
                                elif joueur.get_plateaux() <= 0 and joueur.get_plateauy() <= 0:
                                    # Definir les nouveaux pv suite à l'echange
                                    joueur.set_plateauy((joueur.get_plateaux() + 2))
                                    interface.get_liste_joueur()[joueur.get_id()][4] = joueur.get_plateaux()
                                ...
                                if joueur.get_plateaux() > 1:
                                    # Definir les nouveaux pv suite à l'echange
                                    joueur.set_plateaux((joueur.get_plateaux() - 2))
                                    interface.get_liste_joueur()[joueur.get_id()][3] = joueur.get_plateaux()
                                    
                                    pygame.display.update() # Mettre à jour l'affichage
                                    selection_malus = True
                                    return interface.get_liste_joueur()
                                elif joueur.get_plateaux() <= 1 and joueur.get_plateauy() > 1:
                                    # Definir les nouveaux pv suite à l'echange
                                    joueur.set_plateauy((joueur.get_plateauy() - 2))
                                    interface.get_liste_joueur()[joueur.get_id()][4] = joueur.get_plateauy()
                                    ...
                                    # Definir les nouveaux pv suite à l'echange
                                    joueur.set_plateauy((joueur.get_plateaux() + 3))
                                    interface.get_liste_joueur()[joueur.get_id()][4] = joueur.get_plateaux()
                                ...
                                if joueur.get_plateaux() > 2:
                                    # Definir les nouveaux pv suite à l'echange
                                    joueur.set_plateaux((joueur.get_plateaux() - 3))
                                    interface.get_liste_joueur()[joueur.get_id()][3] = joueur.get_plateaux()
                                    
                                    pygame.display.update() # Mettre à jour l'affichage
                                    selection_malus = True
                                    return interface.get_liste_joueur()
                                elif joueur.get_plateaux() <= 2 and joueur.get_plateauy() > 2:
                                    # Definir les nouveaux pv suite à l'echange
                                    joueur.set_plateauy((joueur.get_plateauy() - 3))
                                    interface.get_liste_joueur()[joueur.get_id()][4] = joueur.get_plateauy()
                                    ...
                                    # Definir les nouveaux pv suite à l'echange
                                    joueur.set_plateauy((joueur.get_plateaux() + 4))
                                    interface.get_liste_joueur()[joueur.get_id()][4] = joueur.get_plateaux()
    ...
    def Action_couleur_Rouge(self, interface, joueur):
        if joueur.avoir_tt_cles() != True:
            ...
            joueur.affichage_image(100,400,interface.get_fenetre(),interface.get_police())
        ...
        #Afficher le joueur et l'adversaire
        joueur.affichage_image(100,400,interface.get_fenetre(),interface.get_police())
        un_ennemis.affichage_image(interface.get_fenetre(),interface.get_police())
        ...
        while combat_en_cours:
            if joueur.get_pv()>0:
                interface.Menu_bas(joueur)
                un_ennemis.affichage_pv_combat(interface.get_fenetre(),interface.get_police())
            ...
            if un_ennemis.get_pv()>0 and joueur.get_pv()>0:
                ...
                joueur.affichage_cle(interface.get_fenetre())           
                pygame.display.update()
                pygame.time.delay(1500)
                combat_en_cours =False
                selection_combat = True
    ...
    def Action_couleur_Violet(self, interface, joueur):
        ...
        interface.Mise_a_jour(joueur)
        joueur.affiche_tt_joueur(interface.get_liste_joueur(),interface.get_fenetre())
...
if __name__ == "__main__" :
    ...
    plateau_de_jeu.set_cases_decouvertes([[i, j] for i in range(0, 10) for j in range(0, 17)])
