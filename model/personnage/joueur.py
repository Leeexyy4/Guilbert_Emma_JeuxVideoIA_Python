...
class Joueur:
    ...
    def affiche_tt_joueur(self,liste_joueur,fenetre):
        """Affiche tous les joueurs sur le plateau."""
        if len(liste_joueur) == 1:
            J1  = Joueur(0,liste_joueur[0][1], liste_joueur[0][2],liste_joueur[0][3], liste_joueur[0][4])
            J1.affichage_image_plateau(J1.get_x(),J1.get_y(),fenetre)
            pygame.display.update()
            return J1
        elif len(liste_joueur) == 2:
            J1 = Joueur(0,liste_joueur[0][1], liste_joueur[0][2],liste_joueur[0][3], liste_joueur[0][4])
            J2 = Joueur(1,liste_joueur[1][1], liste_joueur[1][2],liste_joueur[1][3], liste_joueur[1][4])
            J1.affichage_image_plateau(J1.get_x(),J1.get_y(),fenetre)
            J2.affichage_image_plateau(J2.get_x(),J2.get_y(),fenetre)
            pygame.display.update()
            return J1, J2
        elif len(liste_joueur) == 3:
            J1 = Joueur(0,liste_joueur[0][1], liste_joueur[0][2],liste_joueur[0][3], liste_joueur[0][4])
            J2 = Joueur(1,liste_joueur[1][1], liste_joueur[1][2],liste_joueur[1][3], liste_joueur[1][4])
            J3 = Joueur(2,liste_joueur[2][1], liste_joueur[2][2],liste_joueur[2][3], liste_joueur[2][4])
            J1.affichage_image_plateau(J1.get_x(),J1.get_y(),fenetre)
            J2.affichage_image_plateau(J2.get_x(),J2.get_y(),fenetre)
            J3.affichage_image_plateau(J3.get_x(),J3.get_y(),fenetre)
            pygame.display.update()
            return J1, J2, J3
        elif len(liste_joueur) == 4:
            J1 = Joueur(0,liste_joueur[0][1], liste_joueur[0][2],liste_joueur[0][3], liste_joueur[0][4])
            J2 = Joueur(1,liste_joueur[1][1], liste_joueur[1][2],liste_joueur[1][3], liste_joueur[1][4])
            J3 = Joueur(2,liste_joueur[2][1], liste_joueur[2][2],liste_joueur[2][3], liste_joueur[2][4])
            J4 = Joueur(3,liste_joueur[3][1], liste_joueur[3][2],liste_joueur[3][3], liste_joueur[3][4])
            J1.affichage_image_plateau(J1.get_x(),J1.get_y(),fenetre)
            J2.affichage_image_plateau(J2.get_x(),J2.get_y(),fenetre)
            J3.affichage_image_plateau(J3.get_x(),J3.get_y(),fenetre)
    ...
    def combat_joueurs(self, interface, ordre_adv):
        # Combats des joueurs
        joueur_adv = Joueur(interface.get_liste_joueur()[ordre_adv][0],interface.get_liste_joueur()[ordre_adv][1],interface.get_liste_joueur()[ordre_adv][2],interface.get_liste_joueur()[ordre_adv][3],interface.get_liste_joueur()[ordre_adv][4])
        joueur_adv.set_inventaire(interface.get_liste_joueur()[ordre_adv][6])
        joueur_adv.set_pv(interface.get_liste_joueur()[ordre_adv][5])
        ...
        self.affichage_image(100,400,interface.get_fenetre(),interface.get_police())
        self.affichage_pv_combat(interface.get_fenetre(),interface.get_police())
        joueur_adv.affichage_image(620,400,interface.get_fenetre(),interface.get_police())
        joueur_adv.affichage_pv_combat_adv(interface.get_fenetre(),interface.get_police())
        ...
        while combat_en_cours:
            ...
            while selection_combat != True:
                if self.get_pv()<=0:
                    interface.Menu_bas(self)
                    interface.get_liste_joueur()[self.get_id()][5] = self.get_pv()
                    joueur_adv.affichage_pv_combat_adv(interface.get_fenetre(),interface.get_police())
                    ...
                    for event in pygame.event.get():
                        ...
                        if event.type == pygame.MOUSEBUTTONDOWN:  
                            if 100 < mouse_x < 164 and 508 < mouse_y < 572:
                                ...
                                if toucher == True:
                                    if self.get_element() == self.get_element():
                                    ...
                                    self.set_x(620); self.set_y(400)
                                    pygame.display.update()
                                    pygame.time.delay(2000)
                                    self.set_x(100); self.set_y(400)
                                    selection_combat = True
                                else:
                                    interface.Menu_bas(self)
                                    joueur_adv.affichage_pv_combat_adv(interface.get_fenetre(),interface.get_police())
                            ...
                            if 400 < mouse_x < 464 and 508 < mouse_y < 572:
                                ...
                                if toucher == True:
                                    ...
                                    joueur_adv.affichage_pv_combat(interface.get_fenetre(),interface.get_police())
            ...
            interface.Menu_bas(self)
            joueur_adv.affichage_pv_combat_adv(interface.get_fenetre(),interface.get_police())
            texte.Texte("C'est au tour de l'adversaire", couleur.Couleur().get_Noir(), 110, 600).affiche(interface.get_police(),interface.get_fenetre())
            pygame.display.update()
            pygame.time.delay(2000)
            if joueur_adv.get_pv()>0:
                interface.Menu_bas(joueur_adv)
                self.affichage_pv_combat_adv(interface.get_fenetre(),interface.get_police())
                # Dessiner le rectangle pour les pv du joueur
                texte.Texte("Que veux-tu faire ? Une attaque basique, une ", couleur.Couleur().get_Noir(), 110, 600).affiche(interface.get_police(),interface.get_fenetre())
                texte.Texte("attaque speciale, te defendre ou prendre", couleur.Couleur().get_Noir(), 110, 620).affiche(interface.get_police(),interface.get_fenetre())
                texte.Texte("la fuite ?", couleur.Couleur().get_Noir(), 110, 640).affiche(interface.get_police(),interface.get_fenetre())
            ...
            while selection_combat != True:
                if joueur_adv.get_pv()<=0:
                    interface.Menu_bas(joueur_adv)
                    interface.get_liste_joueur()[joueur_adv.get_id()][5] = joueur_adv.get_pv()
                    self.affichage_pv_combat_adv(interface.get_fenetre(),interface.get_police())
                    texte.Texte("Fin du combat... Tu n'as pas survecu",couleur.Couleur().get_Noir(),110, 600).affiche(interface.get_police(),interface.get_fenetre())
                    texte.Texte("à l'attaque de l'adversaire...",couleur.Couleur().get_Noir(),110, 620).affiche(interface.get_police(),interface.get_fenetre())
                    texte.Texte("Retour au plateau !",couleur.Couleur().get_Noir(),110, 640).affiche(interface.get_police(),interface.get_fenetre())
                    ...
                    combat_en_cours = False
                    return joueur_adv
                elif joueur_adv.get_pv()>0 and joueur_adv.get_pv()>0:
                    mouse_x, mouse_y = pygame.mouse.get_pos() # Recuperer les coordonnees de la souris
                    for event in pygame.event.get():
                        if event.type == pygame.QUIT: # si le joueur quitte la fenetre # si le joueur quitte la fenetre
                            pygame.quit()
                        ...
                        if event.type == pygame.MOUSEBUTTONDOWN:  
                            if 100 < mouse_x < 164 and 508 < mouse_y < 572:
                                toucher = random.choice([True,False,True])
                                if toucher == True:
                                    if joueur_adv.get_element() == joueur_adv.get_element():
                                        #action_joueur = "attaque basique"
                                        pv = random.randint(120,180)
                                        self.set_pv(self.get_pv()-pv)
                                    else:
                                        #action_joueur = "attaque basique"
                                        pv = random.randint(100,140)
                                        self.set_pv(self.get_pv()-pv)
                            ...
                            if 400 < mouse_x < 464 and 508 < mouse_y < 572:
                                ...
                                if toucher == True:
                                    interface.Menu_bas(joueur_adv)
                                    self.set_attaque(self.get_attaque()-20)
                                    self.affichage_pv_combat(interface.get_fenetre(),interface.get_police())
                                    texte.Texte("Tu as choisi de te defendre, tu fais une", couleur.Couleur().get_Noir(), 110, 600).affiche(interface.get_police(),interface.get_fenetre())
                                    texte.Texte("grimace au boss et cela reduit les degâts", couleur.Couleur().get_Noir(), 110, 620).affiche(interface.get_police(),interface.get_fenetre())
                                    texte.Texte("qu'il peut t'infliger." ,couleur.Couleur().get_Noir(), 110, 640).affiche(interface.get_police(),interface.get_fenetre())
