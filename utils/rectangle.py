...
class Rectangle:
    ...
    def get_couleur(self):
        """_summary_
            Renvoie la couleur du rectangle
        """
    ...
    def set_x(self,x:int):
        """_summary_
            Modifie la position(valeur) de X
        """
        self.__x = x
    
    def set_y(self,y:int):
        """_summary_
            Modifie position(valeur) de Y
        """
        self.__y = y
    ...
    def affiche_contour(self,surface,contour):
        """_summary_
            La fonction "affiche_contour" affiche le rectangle et ses contours noirs sur l'interface pygame(Surface surface)
        """        
        # Dessiner les bords de la place pour les cles
    ...
    def affiche_contour_couleur(self,surface,contour):
        """_summary_
            La fonction "affiche_contour_couleur" affiche le rectangle et ses contours colores sur l'interface pygame(Surface surface)
        """     
