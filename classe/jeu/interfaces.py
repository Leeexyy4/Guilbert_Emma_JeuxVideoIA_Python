...
class Interface:
    ...
    def Page_nb_ia(self):
        ...
        if self.get_nb_joueur() == 4 :
            ...
            image.Image(400,595,image.BtnMenu.BTN_0).affiche(self.get_fenetre())
            image.Image(500,595,image.BtnMenu.BTN_1).affiche(self.get_fenetre())
            deux_visible = False; trois_visible = False; quatre_visible = False
        elif self.get_nb_joueur() == 2:
            image.Image(400,595,image.BtnMenu.BTN_0).affiche(self.get_fenetre())
            image.Image(500,595,image.BtnMenu.BTN_1).affiche(self.get_fenetre())
            image.Image(600,595,image.BtnMenu.BTN_2).affiche(self.get_fenetre())
            trois_visible = False; quatre_visible = False
        elif self.get_nb_joueur() == 1:
            image.Image(400,595,image.BtnMenu.BTN_0).affiche(self.get_fenetre())
            image.Image(500,595,image.BtnMenu.BTN_1).affiche(self.get_fenetre())
            image.Image(600,595,image.BtnMenu.BTN_2).affiche(self.get_fenetre())
            image.Image(700,595,image.BtnMenu.BTN_3).affiche(self.get_fenetre())
